...
class BaseRepository(Generic[ModelType, CreateSchemaType, UpdateSchemaType]):
    """
    Base Repository class with asynchronous CRUD methods.
    It encapsulates SQLAlchemy commands and type checking.
    """
    ...
    async def create(self, db: AsyncSession, *, obj_in: CreateSchemaType) -> ModelType:
        ...
        db.add(db_obj)
        # Commit should ideally be managed by the router/session dependency, but flushing assigns the ID
        await db.flush()
